...
class LabelClassProcessor:
    ...
    def filter_by_lots_boundary(self, grid_path):
        """Сравнивает объекты Land_"Сокр"_сетка с границами Lots_"Сокр" и удаляет объекты 
        с определенными LandCode (123, 3, 6, 7), если они не входят в контур Lots_"Сокр".
