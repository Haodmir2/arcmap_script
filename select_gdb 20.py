                            ...
                            try:
                                ...
                                if mapping.ListDataFrames(mxd):
                                    ...
                                    try:
                                        ...
                                        # Сохраняем именованную копию MXD
                                        try:
                                            ...
                                            logging.info("Сохранена копия карты с добавленным слоем сетки: {}".format(mxd_path))
                                        except Exception as save_err:
                                            logging.error("Ошибка при сохранении копии карты: {}".format(str(save_err)))
