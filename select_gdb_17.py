...
class OldForestGDBSelector:
    def __init__(self, master):
        ...
        # Предупреждение, если arcpy недоступен
        if not ARCPY_AVAILABLE:
            self.warning_label = ttk.Label(self.main_frame,
        ...
        self.browse_button = ttk.Button(self.path_frame, 
                                     text="Обзор...", 
        ...
        # Добавляем подсказку
        self.hint_label = ttk.Label(self.main_frame,
                                  text="Выберите файл с расширением .gdb или .mdb",
                                  font=("Arial", 9, "italic"))
